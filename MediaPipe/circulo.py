...
def reconocer_letra(hand_landmarks, frame):
    ...
    #cuadrado
    center_x = pulgar[0] + 20
    center_y = pulgar[1] + 20
    size = int(distancia_indice_medio)
    ...
    #cv2.polylines(frame, [pts], True, (34, 234, 65), 2)
    
    cv2.rectangle(frame,(center_x,center_y),(indice[0],indice[1]),  (34,234,65), 3 )
